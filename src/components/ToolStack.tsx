...
function getToolLogo(name: string) {
  switch (name) {
    ...
    case "React":
      return (
        <svg className="w-5 h-5 text-cyan-400 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    case "Next.js":
      return (
        <svg className="w-5 h-5 text-zinc-900 dark:text-zinc-100 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    case "Tailwind CSS":
      return (
        <svg className="w-5 h-5 text-sky-400 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    case "Antigravity":
      return (
        <svg className="w-5 h-5 text-emerald-400 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    case "Adobe Illustrator":
      return (
        <svg className="w-5 h-5 text-amber-600 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    case "Adobe Photoshop":
      return (
        <svg className="w-5 h-5 text-blue-400 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    case "LottieFiles":
      return (
        <svg className="w-5 h-5 text-teal-400 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export function ToolStack() {
  const categoryHeaders: Record<'Design' | 'Frontend' | 'Development', { title: string; emoji: string }> = {
    Design: { title: "Design", emoji: "🎨" },
    Frontend: { title: "Frontend", emoji: "💻" },
    Development: { title: "Development", emoji: "⚙️" },
  };
      ...
      <div className="max-w-4xl mx-auto px-6 space-y-12">
        ...
        <div>
          ...
          <p className="text-zinc-600 dark:text-zinc-400 mt-2 text-base max-w-xl">
            A curated stack categorized into Design, Frontend, and Development tools.
          </p>
        </div>
              ...
              <div key={catKey} className="space-y-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                  {groupTools.map((tool) => (
                    <div
                      key={tool.name}
                      className="p-3.5 rounded-xl bg-zinc-50 dark:bg-[#121215] border border-zinc-200/80 dark:border-zinc-800/80 flex items-center gap-3 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors"
                    >
                      {/* Tool SVG Logo Container */}
                      <div className="w-8 h-8 rounded-lg bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 flex items-center justify-center shrink-0 shadow-2xs">
