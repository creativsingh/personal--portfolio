...
export const PERSONA_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      tagline: "A food delivery platform designed to connect customers, restaurants, and delivery partners through a seamless, scalable ecosystem.",
      role: "Product Designer & Researcher",
    ...
    },
    {
      ...
      title: "Scalie",
      category: "HR Tech",
      tagline: "Bench resource management platform designed to help organizations efficiently track, allocate, and utilize available talent across projects.",
      role: "Product Designer & Researcher",
      roleDescription: "Product Designer & Researcher. Built automated design token sync pipeline translating Figma variables to type-safe Tailwind and CSS variables for cross-platform engineering teams.",
      period: "2023",
      duration: "6 Months",
      teamSize: "Individual Contributor",
      platform: "Desktop",
